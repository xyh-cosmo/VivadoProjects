...
set_property DIFF_TERM true [get_ports EOUT_P]
set_property DIFF_TERM true [get_ports FOUT_P]
set_property DIFF_TERM true [get_ports GOUT_P]
set_property DIFF_TERM true [get_ports HOUT_P]
set_property DIFF_TERM true [get_ports EOUT_N]
set_property DIFF_TERM true [get_ports FOUT_N]
set_property DIFF_TERM true [get_ports GOUT_N]
set_property DIFF_TERM true [get_ports HOUT_N]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets GH_DCO]

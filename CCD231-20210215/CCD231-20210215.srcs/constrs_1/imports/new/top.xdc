...
set_property IOSTANDARD LVCMOS18 [get_ports CLKP]
set_property IOSTANDARD LVCMOS18 [get_ports SDO]

set_property IOSTANDARD LVCMOS18 [get_ports ENC]
set_property IOSTANDARD LVCMOS18 [get_ports PD]
set_property IOSTANDARD LVCMOS18 [get_ports IV_5K_CTR]
set_property IOSTANDARD LVCMOS18 [get_ports ADG772_CTR]
set_property IOSTANDARD LVCMOS18 [get_ports DUMPOUT]

set_property IOSTANDARD LVCMOS18 [get_ports EOUT_P]
set_property IOSTANDARD LVCMOS18 [get_ports EOUT_N]
set_property IOSTANDARD LVCMOS18 [get_ports FOUT_P]
set_property IOSTANDARD LVCMOS18 [get_ports FOUT_N]
set_property IOSTANDARD LVCMOS18 [get_ports GOUT_P]
set_property IOSTANDARD LVCMOS18 [get_ports GOUT_N]
set_property IOSTANDARD LVCMOS18 [get_ports HOUT_P]
set_property IOSTANDARD LVCMOS18 [get_ports HOUT_N]

set_property IOSTANDARD LVCMOS18 [get_ports EF_FR_P]
set_property IOSTANDARD LVCMOS18 [get_ports EF_FR_N]
set_property IOSTANDARD LVCMOS18 [get_ports GH_FR_P]
set_property IOSTANDARD LVCMOS18 [get_ports GH_FR_N]
set_property IOSTANDARD LVCMOS18 [get_ports EF_DCO_P]
set_property IOSTANDARD LVCMOS18 [get_ports EF_DCO_N]
set_property IOSTANDARD LVCMOS18 [get_ports GH_DCO_P]
set_property IOSTANDARD LVCMOS18 [get_ports GH_DCO_N] 
